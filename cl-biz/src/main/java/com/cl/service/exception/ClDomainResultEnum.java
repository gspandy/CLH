 ...
 *
 */
public enum ClDomainResultEnum {
	 ...
	 * @param message
	 */
	private ClDomainResultEnum(String code, String message) {
		this.code = code;
	 ...
	 */
	public static ClDomainResultEnum getByCode(String code) {
		for (ClDomainResultEnum _enum : values()) {
	 ...
	 */
	public List<ClDomainResultEnum> getAllEnum() {
		List<ClDomainResultEnum> list = new ArrayList<ClDomainResultEnum>();
		for (ClDomainResultEnum _enum : values()) {
			list.add(_enum);
		}
		return list;
